        ...
        private void setBookingDates(BookingResponseDTO booking) {
            try {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                    startDate = booking.getStartTime() != null ?
                            booking.getStartTime().format(DATE_FORMATTER) : "N/A";
                }
                String endDate = null;
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                    endDate = booking.getEndTime() != null ?
                            booking.getEndTime().format(DATE_FORMATTER) : "N/A";
                }
