...
public class AddCarActivity extends AppCompatActivity {
    ...
    public static class CarInfoFragment extends Fragment implements PageFragment {
        private TextInputEditText etPlate, etKms;
        private android.widget.Spinner spBrand, spModel, spYear, spSeat, spFuel;
        ...
        public void onViewCreated(@NonNull android.view.View v, @Nullable Bundle savedInstanceState) {
            ...
            spModel = v.findViewById(R.id.spinner_model);
            ...
            String[] models = {"CAMRY", "CIVIC", "CX5"};
            spModel.setAdapter(new android.widget.ArrayAdapter<>(requireContext(), android.R.layout.simple_spinner_item, models));
        ...
        public void putData(CarDTO car) throws Exception {
            ...
            car.setModel(spModel.getSelectedItem().toString());
    ...
    // ==========================================================
    // 🔹 Fragment 3: Giấy tờ xe (URL + preview)
    // ==========================================================
    public static class CarDocumentsFragment extends Fragment implements PageFragment {
        private TextInputEditText etDoc1, etDoc2;
        ...
        @Override
        public void onViewCreated(@NonNull android.view.View v, @Nullable Bundle savedInstanceState) {
            etDoc1 = v.findViewById(R.id.et_doc1);
            etDoc2 = v.findViewById(R.id.et_doc2);
            ivDoc1 = v.findViewById(R.id.iv_doc1_preview);
            ivDoc2 = v.findViewById(R.id.iv_doc2_preview);

            setupPreview(etDoc1, ivDoc1);
            setupPreview(etDoc2, ivDoc2);
        }
        ...
        @Override
        public void putData(CarDTO car) {
            if (car.getItemImages() == null) car.setItemImages(new ArrayList<>());
            addDoc(car, etDoc1);
            addDoc(car, etDoc2);
        }

        private void addDoc(CarDTO car, TextInputEditText et) {
            if (et != null && et.getText() != null && !et.getText().toString().trim().isEmpty()) {
                car.getItemImages().add(new ItemImageDTO(null, et.getText().toString().trim(), null));
            }
        }
    }
    ...
    public static class CarPriceFragment extends Fragment implements PageFragment {
        ...
        public void putData(CarDTO car) throws Exception {
            ...
            double price = 0.0;
            try { price = Double.parseDouble(p); } catch (Exception ignored) {}
        }
    }
}
