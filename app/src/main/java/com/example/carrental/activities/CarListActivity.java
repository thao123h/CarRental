...
public class CarListActivity extends AppCompatActivity {
    ...
    private void loadCarList() {
        ...
        itemService.getAllCars().enqueue(new Callback<BaseResponse<List<CarDTO>>>() {
            @Override
            public void onResponse(@NonNull Call<BaseResponse<List<CarDTO>>> call, @NonNull Response<BaseResponse<List<CarDTO>>> response) {
                ...
                if (response.isSuccessful() && response.body() != null && response.body().getData() != null) {
                    ...
                    Log.e("CarList", "Response không hợp lệ hoặc data null. Code: " + response.code());
                    Toast.makeText(CarListActivity.this, "Không thể tải danh sách xe", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(@NonNull Call<BaseResponse<List<CarDTO>>> call, @NonNull Throwable t) {
    ...
    public boolean onContextItemSelected(@NonNull MenuItem item) {
        ...
        CarDTO selectedCar = carAdapter.getCarList().get(position);
        ...
        if (itemId == R.id.menu_edit) {
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setMessage("Bạn có chắc chắn muốn xóa xe '" + selectedCar.getBrand() + " " + selectedCar.getModel() + "' không?")
    ...
    private void deleteCar(CarDTO carToDelete, int position) {
