...
public class BookingDetailActivity extends AppCompatActivity {
    ...
    private void displayBookingDetails() {
        ...
        // Set dates
        try {
            String startDate = currentBooking.getStartTime() != null ?
                    currentBooking.getStartTime().format(DATE_FORMATTER) : "N/A";
            String endDate = currentBooking.getEndTime() != null ?
                    currentBooking.getEndTime().format(DATE_FORMATTER) : "N/A";
